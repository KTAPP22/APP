    ...
    <div className="w-full min-h-full flex flex-col items-center justify-start sm:justify-center bg-dark-gray p-4 sm:p-8 overflow-y-auto">
      <div className="w-full max-w-md space-y-6 sm:space-y-8 bg-pure-black p-4 sm:p-8 rounded-2xl border border-gray-800 my-4">
        ...
        <form onSubmit={handleStart} className="space-y-6">
          ...
          <div>
            <label className="block text-gray-400 text-base sm:text-xl mb-2 font-sans">Duración del Stint</label>
            <div className="flex gap-4">
              <input 
                type="number" 
                value={stintDuration}
                onChange={(e) => setStintDuration(e.target.value)}
                className="w-2/3 bg-dark-gray text-white text-xl sm:text-3xl p-3 sm:p-4 rounded-xl border border-gray-700 focus:border-neon-green focus:outline-none"
                min="1"
                required
              />
              <select 
                ...
                className="w-1/3 bg-dark-gray text-white text-base sm:text-xl p-3 sm:p-4 rounded-xl border border-gray-700 focus:border-neon-green focus:outline-none appearance-none cursor-pointer"
              >
          ...
          <div>
            <label className="block text-gray-400 text-base sm:text-xl mb-2 font-sans">URL de Apex Timing</label>
            <input 
              type="text" 
              value={circuitId}
              onChange={(e) => setCircuitId(e.target.value)}
              className="w-full bg-dark-gray text-white text-base sm:text-lg p-3 sm:p-4 rounded-xl border border-gray-700 focus:border-neon-green focus:outline-none"
          ...
          <div>
            <label className="block text-gray-400 text-base sm:text-xl mb-2 font-sans">Puerto Apex Timing (Opcional)</label>
            <input 
              type="number" 
              value={apexPort}

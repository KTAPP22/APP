...
export const TimesBlock = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center p-2 border-b border-dark-gray bg-pure-black h-full gap-1 landscape:gap-0.5 sm:gap-8 overflow-hidden">

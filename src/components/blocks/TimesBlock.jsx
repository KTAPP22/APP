...
export const TimesBlock = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center p-2 border-b landscape:border-b-0 border-white/20 landscape:border-r md:border-0 bg-pure-black h-full gap-1 landscape:gap-0.5 sm:gap-8 overflow-hidden">
